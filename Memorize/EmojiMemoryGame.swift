...
class EmojiMemoryGame: ObservableObject {
    ...
    @Published private var model = createMemoryGame(randomTheme() ?? theme1)
    ...
    func newGame() {
        model = EmojiMemoryGame.createMemoryGame(EmojiMemoryGame.randomTheme() ?? EmojiMemoryGame.theme1)
    }
